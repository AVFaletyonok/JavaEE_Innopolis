...
public class StudentControllerTest {
    ...
    void updateCorrectStudent() throws Exception {
        Mockito.when(studentService.updateStudent(updateCorrectStudent))
                .thenReturn(Optional.of(updateCorrectStudent));
    ...
    void updateWrongStudent() throws Exception {
        Mockito.when(studentService.updateStudent(updateWrongStudent))
                .thenReturn(Optional.empty());
