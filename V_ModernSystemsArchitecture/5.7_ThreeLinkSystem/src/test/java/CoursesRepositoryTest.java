...
public class CoursesRepositoryTest {
    ...
    void findByCourseIdTest() {
        ...
        Assertions.assertNotNull(gottenCourse);
        Assertions.assertEquals(course.getId(), gottenCourse.getId());
        Assertions.assertEquals(course.getCourseId(), gottenCourse.getCourseId());
    }
}
