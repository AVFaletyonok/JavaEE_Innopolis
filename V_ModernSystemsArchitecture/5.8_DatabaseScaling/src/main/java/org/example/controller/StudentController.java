...
//    @Qualifier(value = "studentService")
    ...
    @PostMapping("/send-notifications-all")
    public ResponseEntity sendNotifications(@RequestBody String message) {
        studentService.sendNotifications(message, "topic-1-All");
