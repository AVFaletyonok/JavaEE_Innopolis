...
//    @WithMockUser(username = "admin", roles = "ADMIN")
    ...
    void getStudents() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/v1/students"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].id").value(correctStudent.getId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].firstName").value(correctStudent.getFirstName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].lastName").value(correctStudent.getLastName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].patronymic").value(correctStudent.getPatronymic()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].email").value(correctStudent.getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].coursesNames").doesNotExist())
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].reviews").doesNotExist());
    }
    ...
    */
    ...
    void signUpForCorrectCourse() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.patronymic").value(correctStudent.getPatronymic()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.email").value(correctStudent.getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.coursesNames[0]")
    ...
    void leaveReviewOnCorrectCourse() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.coursesNames[0]")
                        .value(correctStudentResponseWithCourses.getCoursesNames().get(0)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.reviews[0].courseName").value(courseName))
                .andExpect(MockMvcResultMatchers.jsonPath("$.reviews[0].text").value(reviewText));
    }
    ...
    void getStudentsByCorrectCourse() throws Exception {
        ...
        mvc.perform((MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].id").value(correctStudentWithCourse.getId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].firstName").value(correctStudentWithCourse.getFirstName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].lastName").value(correctStudentWithCourse.getLastName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].patronymic").value(correctStudentWithCourse.getPatronymic()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].email").value(correctStudentWithCourse.getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].coursesNames").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].coursesNames.[0]")
                        .value(correctStudentResponseWithCourses.getCoursesNames().get(0)));
    }
